...
// #include "VWO/data/marker.h"
#include "VWO/data/map_database.h"
#include "VWO/optimize/global_bundle_adjuster.h"
#include "VWO/optimize/terminate_action.h"
#include "VWO/optimize/internal/landmark_vertex_container.h"
// #include "VWO/optimize/internal/marker_vertex_container.h"
#include "VWO/optimize/internal/se3/shot_vertex_container.h"
...
void optimize_impl(g2o::SparseOptimizer& optimizer,
    ...
    auto linear_solver = ::make_unique<g2o::LinearSolverCSparse<g2o::BlockSolver_6_3::PoseMatrixType>>();
    block_solver = ::make_unique<g2o::BlockSolver_6_3>(std::move(linear_solver));
...
void global_bundle_adjuster::optimize_for_initialization(const std::vector<std::shared_ptr<data::keyframe>>& keyfrms,
    ...
    optimize_impl(optimizer, keyfrms, lms, is_optimized_lm, keyfrm_vtx_container, lm_vtx_container,
                  num_iter_, use_huber_kernel_, force_stop_flag);
