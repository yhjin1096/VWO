...
std::vector<unsigned int> get_keypoints_in_cell(const Camera* camera, const data::frame_observation& frm_obs,
...
Vec3_t triangulate_stereo(const Camera* camera,
    ...
    switch (camera->model_type_) {
        case Camera::model_type_t::Perspective: {
            auto perspective_camera = static_cast<const Perspective*>(camera);
