...
#include "VWO/optimize/internal/se3/perspective_reproj_edge.h"
// #include "VWO/optimize/internal/se3/equirectangular_reproj_edge.h"
...
inline reproj_edge_wrapper<T>::reproj_edge_wrapper(const std::shared_ptr<T>& shot, shot_vertex* shot_vtx,
    ...
    switch (camera_->model_type_) {
        case Camera::model_type_t::Perspective: {
            auto c = static_cast<Perspective*>(camera_);
            if (is_monocular_) {
